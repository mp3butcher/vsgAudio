...
SoundData::SoundBuffer::SoundBuffer() noexcept(false) : buffername_(0) {
...
SoundData::SoundData()  noexcept(false) : vsg::Inherit<AudioBase,SoundData>() {
...
SoundData::SoundData(const SoundData &sounddata)
    :vsg::Inherit<AudioBase,SoundData>() {
