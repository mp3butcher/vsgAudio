...
SoundNode::SoundNode()
    :vsg::Inherit<vsg::Node,SoundNode>(),
...
SoundNode::SoundNode(SoundState *sound_state, SoundManager *sound_manager)
 :vsg::Inherit<vsg::Node,SoundNode>(), m_sound_state(sound_state),
...
SoundNode::SoundNode(const SoundNode &copy, const vsg::CopyOp &copyop)
 :vsg::Inherit<vsg::Node,SoundNode>(copy, copyop)
{
    *this = copy;
}
/*
