...
public:
    ...
    /**
        ...
        */
    void setReverbScale(float scale) noexcept(false);
    ...
    /**
        ...
        */
    void setReverbDelay(float delay) noexcept(false);

    /**
        * Get reverb delay for this source.
        * @return the delay.
        */
    float getReverbDelay() noexcept(false);
    /**
        * Get reverb scale for this source.
        * @return the scale.
        */
    float getReverbScale() noexcept(false);
    ...
    /**
        ...
        * it.
        */
    ALuint link(const SourceBase *source) noexcept(false);

    /**
        * Unlink this source from another.
        * @param source is the source to unlink.
        */
    void unlink(const SourceBase *source) noexcept(false);

    /**
        * Unlink this source from another.
        * @param name is the name of the source to unlink.
        */
    void unlink(const ALuint name) noexcept(false);
...
protected:
    ...
    /**
        ...
        */
    SourceBase(float x,float y,float z) noexcept(false);
