...
class OPENALPP_API GroupSource : public SourceBase {
    ...
    /**
        ...
        */
    std::vector<vsg::ref_ptr<Source> > sources_;
...
public:
    /**
        ...
        */
    GroupSource(float x = 0.0, float y = 0.0, float z = 0.0) noexcept(false);
    ...
    /**
        ...
        */
    void mixSources(unsigned int frequency=22050) noexcept(false);
    ...
    /**
        ...
        */
    ALuint includeSource(vsg::ref_ptr<Source> source)  noexcept(false);
    ...
    /**
        ...
        */
    void excludeSource(const Source &source)  noexcept(false);
    ...
    /**
        ...
        */
    void excludeSource(ALuint source) noexcept(false);
