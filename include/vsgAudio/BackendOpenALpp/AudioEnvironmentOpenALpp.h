...
#ifndef VSGAUDIO_AUDIOENVIRONMENT_OPENALPP_H
#define VSGAUDIO_AUDIOENVIRONMENT_OPENALPP_H 1
...
class VSGAUDIO_EXPORT AudioEnvironment
{
public:
    ...
    /**
         ...
         */
    void init( bool displayInitMsgs=false ) noexcept(false);
    ...
    /**
         ...
         */
    void setDopplerFactor(float factor) noexcept(false);

    /**
         * Gets the Doppler factor.
         * @return Doppler factor.
         */
    float getDopplerFactor() noexcept(false);
    ...
    /**
         ...
         * @param factor has a default value of one.
         */
    void setUnitScale(float scale) noexcept(false);

    /**
         * Gets the unit scale.  Not used by OpenAL.
         * @return Unit scale.
         */
    float getUnitScale() noexcept(false);
    ...
    /**
         ...
         */
    void setDistanceModel(DistanceModel model) noexcept(false);

    /**
         * Gets the distance model used in attenuation calculations.
         * @return the model.
         */
    DistanceModel getDistanceModel() noexcept(false);

    /**
         * Initiates reverb implementation.
         */
    void initiateReverb() noexcept(false);
...
private:
    ...
    vsg::ref_ptr<openalpp::AudioEnvironment> _openalppAudioEnvironment;
...
#endif /* VSGAUDIO_AUDIOENVIRONMENT_OPENALPP_H */
