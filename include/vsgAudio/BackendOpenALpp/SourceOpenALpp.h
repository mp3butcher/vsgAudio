...
#ifndef vsgAudio_SOURCEOPENALPP_H
#define vsgAudio_SOURCEOPENALPP_H 1
...
class VSGAUDIO_EXPORT Source : public vsg::Inherit<vsgAudio::SourceBase, Source> {
public:
    /**
        * Constructor.
    ...
    /**
        ...
        */
    virtual void setReverbScale(float scale) noexcept(false);
    ...
    /**
        ...
        */
    virtual void setReverbDelay(float delay) noexcept(false);

    /**
        * Get reverb delay for this source.
        * @return the delay.
        */
    virtual float getReverbDelay() noexcept(false);

    /**
        * Get reverb scale for this source.
        * @return the scale.
        */
    virtual float getReverbScale() noexcept(false);
    ...
    /**
        * Get internal openalpp Source object (used only by vsgAudio openalpp Adapter layer)
        * @return openalp::Source object wrapped by vsgAudio.
        */
...
private:
    vsg::ref_ptr<openalpp::Source> _openalppSource;
}; // Source

} // namespace vsgAudio

#endif /* vsgAudio_SOURCEOPENALPP_H */
