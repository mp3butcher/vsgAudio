...
#ifndef vsgAudio_LISTENER_OPENALPP_H
#define vsgAudio_LISTENER_OPENALPP_H 1
...
/*!
    ...
    */
class VSGAUDIO_EXPORT Listener : public vsg::Inherit<vsg::Object, Listener> {
...
private:
    vsg::ref_ptr<openalpp::Listener> _openalppListener;
...
#endif /* vsgAudio_LISTENER_OPENALPP_H */
