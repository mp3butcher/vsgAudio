...
#ifndef VSGAUDIO_AUDIOENVIRONMENT_H
#define VSGAUDIO_AUDIOENVIRONMENT_H 1
...
#include <vsgAudio/BackendOpenALpp/AudioEnvironmentOpenALpp.h>
#endif // ENABLE_SUBSYSTEM_OPENAL

#endif /* VSGAUDIO_AUDIOENVIRONMENT_H */
