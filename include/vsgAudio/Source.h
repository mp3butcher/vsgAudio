...
#ifndef vsgAudio_SOURCE_H
#define vsgAudio_SOURCE_H 1

#include <vsgAudio/Config.h>

#ifdef ENABLE_SUBSYSTEM_FMOD
#include <vsgAudio/BackendFMOD/SourceFMOD.h>
#endif // ENABLE_SUBSYSTEM_FMOD

#ifdef ENABLE_SUBSYSTEM_OPENAL
#include <vsgAudio/BackendOpenALpp/SourceOpenALpp.h>
#endif // ENABLE_SUBSYSTEM_OPENAL

#endif /* vsgAudio_SOURCE_H */
