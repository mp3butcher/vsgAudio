...
#ifndef vsgAudio_LISTENER_H
#define vsgAudio_LISTENER_H 1

#include <vsgAudio/Config.h>

#ifdef ENABLE_SUBSYSTEM_FMOD
#include <vsgAudio/BackendFMOD/ListenerFMOD.h>
#endif // ENABLE_SUBSYSTEM_FMOD

#ifdef ENABLE_SUBSYSTEM_OPENAL
#include <vsgAudio/BackendOpenALpp/ListenerOpenALpp.h>
#endif // ENABLE_SUBSYSTEM_OPENAL


#endif /* vsgAudio_LISTENER_H */
