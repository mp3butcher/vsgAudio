...
#ifndef vsgAudio_LISTENER_FMOD_H
#define vsgAudio_LISTENER_FMOD_H 1
...
private:
    ...
    static vsg::observer_ptr<vsgAudio::Listener> _selectedlistener;

}; // Listener

} // namespace vsgAudio

#endif /* vsgAudio_LISTENER_FMOD_H */
