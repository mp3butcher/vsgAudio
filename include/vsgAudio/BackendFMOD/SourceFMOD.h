...
#ifndef vsgAudio_SOURCEFMOD_H
#define vsgAudio_SOURCEFMOD_H 1
...
class VSGAUDIO_EXPORT Source : public vsgAudio::SourceBase {
public:
    /**
        * Constructor.
    ...
    /**
        * Get internal Source object (used only by vsgAudio FMOD layer)
        * @return FMOD::Channel object wrapped by vsgAudio.
        */
...
private:
    ...
    osg::ref_ptr<vsgAudio::Sound> _Sound;
