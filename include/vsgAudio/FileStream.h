...
#ifndef VSGAUDIO_FILESTREAM_H
#define VSGAUDIO_FILESTREAM_H 1

#include <vsgAudio/Config.h>

#ifdef ENABLE_SUBSYSTEM_FMOD
#include <vsgAudio/BackendFMOD/FileStreamFMOD.h>
#endif // ENABLE_SUBSYSTEM_FMOD

#ifdef ENABLE_SUBSYSTEM_OPENAL
#include <vsgAudio/BackendOpenALpp/FileStreamOpenALpp.h>
#endif // ENABLE_SUBSYSTEM_OPENAL

#endif /* VSGAUDIO_FILESTREAM_H */
