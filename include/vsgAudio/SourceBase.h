...
#ifndef VSGAUDIO_SOURCEBASE_H
#define VSGAUDIO_SOURCEBASE_H 1
...
/**
    ...
    */
class VSGAUDIO_EXPORT SourceBase : public vsg::Inherit<vsg::Object, SourceBase> {
public:
    /**
        * Play the source.
        */
    ...
    /**
        ...
        */
    virtual void setReverbScale(float scale) noexcept(false)= 0;
    ...
    /**
        ...
        */
    virtual void setReverbDelay(float delay) noexcept(false) = 0;

    /**
        * Get reverb delay for this source.
        * @return the delay.
        */
    virtual float getReverbDelay() noexcept(false) = 0;

    /**
        * Get reverb scale for this source.
        * @return the scale.
        */
    virtual float getReverbScale() noexcept(false) = 0;
