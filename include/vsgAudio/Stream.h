...
#ifndef vsgAudio_STREAM_H
#define vsgAudio_STREAM_H 1

#include <vsgAudio/Config.h>

#ifdef ENABLE_SUBSYSTEM_FMOD
#include <vsgAudio/BackendFMOD/StreamFMOD.h>
#endif // ENABLE_SUBSYSTEM_FMOD

#ifdef ENABLE_SUBSYSTEM_OPENAL
#include <vsgAudio/BackendOpenALpp/StreamOpenALpp.h>
#endif // ENABLE_SUBSYSTEM_OPENAL


#endif /* vsgAudio_STREAM_H */
